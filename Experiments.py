...
#display_expectation_of_error_calculation_between_Clasical_SVD_and_Randomized_SVD (si elle est correcte) indique que le SVD randaomme à besoin de prendre des valeurs élevé de k (autour de n/2 ) ou bien il y à une erreur dans la formule du théorème ...
# un problème apparait pour n = 10, m = 100 au nivaux de 'Stage_B', je n'arrive pas à trouver le problème 
